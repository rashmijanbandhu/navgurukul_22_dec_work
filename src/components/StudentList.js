  ...
  return (
    <div>
      <div className="sort-filter-container">
        <div>
          <label>Sort By:</label>
          <select className="select-box" onChange={(e) => setSortCriteria(e.target.value)}>
             <option value="">Select</option>
             <option value="averageGrade">Average Grade</option>
             <option value="attendance">Attendance</option>
          </select>
          <select className="select-box" onChange={(e) => setSortOrder(e.target.value)}>
            <option value="asc">Asc</option>
            <option value="desc">Desc</option>
          </select>
        </div>
        <div>
          <label>Filter By Progress:</label>
          <select className="select-box" onChange={(e) => setFilterProgress(e.target.value)}>
             <option value="">Select</option>
             <option value="High">High Progress</option>
             <option value="Medium">Medium Progress</option>
             <option value="Low">Low Progress</option>
